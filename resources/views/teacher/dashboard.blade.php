    ...
    <div class="layout">
        ...
        <main class="main">
            ...
            <div class="cards">
                <!-- Top row -->
                <div class="top-row">
                    <a href="{{ route('teacher.review.list', ['status' => 'approved']) }}" class="card blue">
                    ...
                    <a href="{{ route('teacher.review.list', ['status' => 'pending']) }}" class="card orange">
                    ...
                    <a href="{{ route('teacher.review.list', ['status' => 'rejected']) }}" class="card red">
