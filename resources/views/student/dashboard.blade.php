        ...
        <div class="layout">
            ...
            <main class="main">
                ...
                <div class="cards">
                    <!-- Top row -->
                    <div class="top-row">
                        <a href="{{ route('student.submitted') }}" class="card green">
                            <p class="label">Submitted Gayle</p>
                            <p class="number">{{ $submittedStudies }}</p>
                            <?xml?><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('student.submitted', ['status' => 'approved']) }}" class="card blue">
                            ...
                            <?xml?><svg data-name="Layer 1" id="Layer_1" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"><title/>
                                <path d="M22.41,10.59L20.36,8.54V5.63a2,2,0,0,0-2-2H15.46l-2.05-2a2,2,0,0,0-2.82,0L8.54,3.64H5.63a2,2,0,0,0-2,2V8.54l-2,2.05A2,2,0,0,0,1,12a2,2,0,0,0,.58,1.41l2.06,2.05v2.91a2,2,0,0,0,2,2H8.54l2.05,2.05A2,2,0,0,0,12,23a2,2,0,0,0,1.41-.58l2.05-2.06h2.91a2,2,0,0,0,2-2V15.46l2.05-2.05a2,2,0,0,0,0-2.82Zm-4.05,4.05v3.72H14.64L12,21,9.36,18.36H5.64V14.64L3,12,5.64,9.36V5.64H9.36L12,3l2.64,2.64h3.72V9.36L21,12Z"/>
                        ...
                        <a href="{{ route('student.submitted', ['status' => 'pending']) }}" class="card orange">
                            ...
                            <?xml?><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="bottom-row">
                        ...
                        <a href="{{ route('student.submitted', ['status' => 'revision']) }}" class="card yellow">
                            <p class="label">Revision(s) To Do</p>
                            <p class="number">{{ $revisionsToDo }}</p>
                            <?xml?><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                <g id="book">
                                    <path d="M16,10.33c-2.21-.21-4.56-.33-7-.33V52c12.7,0,23,3.13,23,7" style="fill:none;stroke:#0a1c28;stroke-linejoin:round;stroke-width:2px"/>
                                    <path d="M9,16H3V59H32V17c0-6.63-7.16-12-16-12V47c8.84,0,16,5.37,16,12" style="fill:none;stroke:#0a1c28;stroke-linejoin:round;stroke-width:2px"/>
                                    <rect height="43" style="fill:none;stroke:#0a1c28;stroke-linejoin:round;stroke-width:2px" width="29" x="32" y="16"/>
                                    <path d="M50,59,61,48H51a2,2,0,0,0-2,2v7a2,2,0,0,1-2,2" style="fill:none;stroke:#0a1c28;stroke-linejoin:round;stroke-width:2px"/>
                                    <polygon points="46 30 46 13 38 13 38 30 42 28 46 30" style="fill:#0a1c28"/>
                                </g>
                            </svg>
                        </a>
                        ...
                        <a href="{{ route('student.submitted', ['status' => 'rejected']) }}" class="card red">
                            ...
                            <?xml?><svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
                                <title/>
                                <g>
