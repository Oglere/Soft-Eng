...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/student/submitted.css') }}">
</head>
<body>
      ...
      <div>
        <div class="menu-section">
          ...
          <div class="menu">
            ...
            <a href="<?php echo e(url('/student/submitted')); ?>" class="active">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <tr data-status="{{ strtolower($submission->status) }}" data-id="{{ $submission->document_id }}">
                    ...
                    <td>
                        <button
                            ...
                            data-id="{{ $submission->document_id }}"
...
<script>
    ...
    document.querySelectorAll('.view-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            reviewButton.href = `/student/view_submitted/${btn.dataset.id}`;
