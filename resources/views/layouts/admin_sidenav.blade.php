<div class="sidebar">
  ...
  <ul>
    ...
    <li><a href="{{ route('admin.dashboard') }}"><i class="fas fa-users"></i> <span class="sidenav_name">Manage Users</span></a></li>
    <li><a href="{{ route('admin.dashboard') }}"><i class="fas fa-database"></i> <span class="sidenav_name">Storage</span></a></li>
