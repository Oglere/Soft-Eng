...
<body style="overflow: hidden; height: calc(100% - 61px)">
    <main>
        <header>
            <div class="ahh">
                <img src="{{ asset('css/style.css') }}" alt="DARA Logo" class="ahh">
            </div>
        </header>
        ...
        <div class="main" style="height: 100%;">
            <div class="left" >
                ...
                <nav class="nav-links">
                    ...
                    <a href="{{ ('/layouts/editacc') }}" class="unq" style="color: #8e0404; font-weight: normal;">Edit Account</a>
                    <a href="{{ ('/layouts/recovery') }}" class="unq">Recovery</a>
